...
exports.MqttFlavoredHarmonyPlatform = void 0;
 ...
 */
class MqttFlavoredHarmonyPlatform {
    ...
    async ensureHarmonyClient() {
        ...
        this.harmonyClient = await client_ws_1.getHarmonyClient('192.168.0.49');
        return this.harmonyClient;
    }
    async send(cmd) {
        ...
        for (const device of exampleDevices) {
            ...
            if (existingAccessory) {
                ...
                if (device) {
                    ...
                    new platformAccessory_1.SimpleHarmonyAccessory(this, existingAccessory);
                ...
                // this is imported from `platformAccessory.ts`
                new platformAccessory_1.SimpleHarmonyAccessory(this, accessory);
...
exports.MqttFlavoredHarmonyPlatform = MqttFlavoredHarmonyPlatform;
